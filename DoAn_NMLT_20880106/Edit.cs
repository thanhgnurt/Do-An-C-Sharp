        ...
        static Struct.HOANGHOA EditItem(int index, ref Struct.HOANGHOA item)
        {
            ...
            switch (index)
            {
                ...
                case 3:
                    ...
                    Console.CursorTop = 12;
                    Console.CursorLeft = 10;
                    item.HanDung.Ngay = InputEditInt(14, 10, "Ngày");
                    break;
                case 4:
                    Console.CursorTop = 12;
                    Console.CursorLeft = 33;
                    ...
                    Console.CursorTop = 12;
                    Console.CursorLeft = 33;
                    item.HanDung.Thang = InputEditInt(14, 33, "Tháng");
                    break;
                case 5:
                    Console.CursorTop = 12;
                    Console.CursorLeft = 56;
                    ...
                    Console.CursorTop = 12;
                    Console.CursorLeft = 56;
                    item.HanDung.Nam = InputEditInt(14, 56, "Năm");
                    break;
                case 6:
                    Console.CursorTop = 16;
                    Console.CursorLeft = 2;
                ...
                case 7:
                    ...
                    Console.CursorTop = 20;
                    Console.CursorLeft = 2;
                    item.NamSX = InputEditInt(22, 2, "Năm sản xuất");
                    break;
                case 8:
                    Console.CursorTop = 24;
                    Console.CursorLeft = 2;
